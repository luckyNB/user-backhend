...
public class Utility {
	...
	public static void send(String toEmail, String subject, String body) {
		final String fromEmail = "laxmanbhosale7374@gmail.com"; // requires valid gmail id
		final String password = "Laxman@2020"; // correct password for gmail id
		...
		try {
			...
			msg.setReplyTo(InternetAddress.parse("laxmanbhosale7374@gmail.com", false));
